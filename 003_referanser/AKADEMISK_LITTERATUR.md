...
## 5. Pensumlitteratur fra LOG650-kompendiet
Kompendiet er strukturert som 33 selvstendige Python-prosjekter (kapittel × seksjon). Hver seksjon har `data/`, `src/`, `output/` og `README.md`, og brukes i denne oppgaven som faglig grunnlag og verifikasjon for metodevalg. Lokal sti: `003_referanser/Kompendium/`. Innholdsfortegnelse: `003_referanser/Kompendium/00_INDEX.md`.
...
### 5.1 Prognose og etterspørsel (kjernepensum for FS2)
...
### 5.2 Lagerstyring og Newsvendor (kjernepensum for FS3)
...
### 5.3 Forsyningskjede og koordinering
...
### 5.4 Lagerstrategi og fasiliteter
...
### 5.5 Bærekraft (kapittel 6.3 og 7)
...
### 5.6 Returlogistikk (metodisk i §4.3)
